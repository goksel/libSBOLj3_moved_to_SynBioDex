package org.sbolstandard.validation;
...
import org.sbolstandard.entity.CombinatorialDerivation;
...
import org.sbolstandard.entity.Experiment;
import org.sbolstandard.entity.ExperimentalData;
...
import org.sbolstandard.entity.LocalSubComponent;
...
import org.sbolstandard.entity.VariableFeature;
...
import org.sbolstandard.entity.measure.Unit;
...
public class SBOLComparator {
	...
	private static StringBuilder assertEqualCombinatorialDerivation(CombinatorialDerivation entity1, CombinatorialDerivation entity2)  throws SBOLGraphException
	{
		...
		if (entity1!=null)
		{
			...
			output = add(output, assertEqualEntity(entity1.getVariableComponents(), entity2.getVariableComponents()));	
		}
		return output;
	}
