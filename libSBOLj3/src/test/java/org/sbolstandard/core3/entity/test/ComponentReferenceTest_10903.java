...
public class ComponentReferenceTest_10903 extends TestCase {
	...
	public void testConstraintReference() throws SBOLGraphException, IOException, Exception
    {
        ...
        //Introduce error: CRef is now in Level2 is created as an entity of the Level 1 multicellularSystem
        ComponentReference csIPTG_SenderL2=multicellularSystem.createComponentReference(scIPTG_SenderL3, scIPTGSenderL3_L2);
